...
uses
  ...
  Dialogs, StdCtrls, CPort, ExtCtrls, Buttons, System.UITypes, Vcl.Menus, UAtualizar;
...
begin
  ...
  try
    ...
    MessageDlg('Não foi encontrada comunicação com a porta serial, verifique as configurações!',mtError, [mbOK], 0);
